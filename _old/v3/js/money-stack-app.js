(function($, namespace, undefined) {
    ...
    namespace.MoneyStacksApp = function(arg) {
        ...
        $.getJSON('data/autocomplete.json', $.proxy(this.initAutpcompletes, this));
    };
    namespace.MoneyStacksApp.prototype = {
        ...
        initAutpcompletes: function(data) {
            // TODO Switch to MoneyStackAutocomplete on real data (remote data source)
            ...
            this.priceInput.MoneyStackAutocomplete({
                source: data
            });
        },
